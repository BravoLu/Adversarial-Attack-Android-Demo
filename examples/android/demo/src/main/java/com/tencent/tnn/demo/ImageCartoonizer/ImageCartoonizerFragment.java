...
//        NpuEnable = mImageCartoonizer.checkNpu(modelPath);
    ...
    private String initModel()
    {
        ...
        String[] modelPathsCartoonizer = {
            "SimpleGenerator.opt.tnnmodel",
            "SimpleGenerator.opt.tnnproto",
        };
...
//                Log.d(TAG, cartoonize_image.l)
                Log.d(TAG, "length size:"+ String.valueOf(imageInfoList[0].data.length));
